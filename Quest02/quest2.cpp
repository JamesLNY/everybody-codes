...
namespace quest2 {
    pair<long long, long long> multiply(pair<long long, long long> A, pair<long long, long long> B) {
    ...
    pair<long long, long long> getA(string fileName) {
    ...
    bool test(pair<long long, long long> A) {
